...
class wanghongbao:
    ...
    def daybyday(self, message1, data, wenjian,hour):
        tem_excel = xlrd.open_workbook(wenjian, formatting_info=True)
        wb = copy(tem_excel)
        s = wb.get_sheet(data)
        ...
        s.write(14, 3, message1, style)
        s.write(14, 5, hour, style)
        wb.save(wenjian)  # 保存
    def daybyday2(self, message1, data, wenjian,hour):
        ...
        s.write(15, 3, message1, style)
        s.write(15, 5, hour, style)
        wb.save(wenjian)  # 保存
    # def count(self,data,wenjian):
    #     tem_excel = xlrd.open_workbook(wenjian, formatting_info=True)
    #     wb = copy(tem_excel)
    #     s = wb.get_sheet(data)
    #     cell1 = s.cell_value(6, 5)
    #     cell2 = s.cell_value(7, 5)
    #     cell3 = s.cell_value(8, 5)
    #     cell4 = s.cell_value(9, 5)
    #     cell5 = s.cell_value(10, 5)
    #     cell6 = s.cell_value(11, 5)
    #     cell7 = s.cell_value(12, 5)
    #     cell8 = s.cell_value(13, 5)
    #     cell9 = s.cell_value(14, 5)
    #     cell10 = s.cell_value(15, 5)
